...
```text
~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_145752
~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_145900
~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_150711
~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_150918
```
...
```bash
ros2 bag info ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_145752
```
...
ros2 bag play ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_145752 --loop
```
...
ros2 bag play ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_145900 --loop
```
...
ros2 bag play ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_150711 --loop
```
...
ros2 bag play ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_150918 --loop
```
...
```bash
ros2 bag play ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_150711 --rate 0.5
ros2 bag play ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_150711 --rate 1.0
ros2 bag play ~/track_robot_ws/rosbags/human_tracking/recordings/human_tracking_lidar_20260706_150711 --rate 2.0
```
