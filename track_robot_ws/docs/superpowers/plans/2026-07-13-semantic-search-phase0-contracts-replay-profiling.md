...
- Authoritative design: docs/superpowers/specs/2026-07-13-language-conditioned-multimodal-semantic-search-design.md.
...
- rosbags/semantic_search/manifests/README.md
- rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json
- rosbags/semantic_search/reports/README.md
- rosbags/semantic_search/reports/phase0_baseline_2026-07-14.json
...
- Create: rosbags/semantic_search/semantic_search_rosbag_guide.md
- Create: rosbags/semantic_search/manifests/README.md
- Create: rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json
...
Terminal 1:
    ...
    ros2 bag record -o ~/track_robot_ws/rosbags/semantic_search/raw/field_001 \
...
artifact actually used. The guard aborts if any value is missing:
    ...
    ros2 run track_robot_semantic_search semantic_search_manifest create-field \
      ~/track_robot_ws/rosbags/semantic_search/raw/field_001 \
      ~/track_robot_ws/rosbags/semantic_search/manifests/field_001.json \
...
Use the ROS source timestamp, not wall-clock time:
    ...
    ros2 run track_robot_semantic_search semantic_search_manifest add-query \
      rosbags/semantic_search/manifests/field_001.json \
      --query-id 1 \
...
annotation.schema.json, validate every record and register its immutable hash:
    ...
    ros2 run track_robot_semantic_search semantic_search_manifest add-annotations \
      rosbags/semantic_search/manifests/field_001.json \
      rosbags/semantic_search/annotations/field_001.jsonl \
      --workspace-root ~/track_robot_ws
...
Terminal 1:
    ...
    ros2 launch track_robot_semantic_search semantic_search_phase0.launch.py \
      ...
      manifest_path:=$HOME/track_robot_ws/rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json \
...
6. In a sourced shell on ROS_DOMAIN_ID 20, run these read-only checks:
       ...
       BAG_PATH="$HOME/track_robot_ws/rosbags/human_tracking_lidar_20260706_150711"
...
Compare:
    ...
    ros2 run track_robot_semantic_search semantic_search_compare_reports \
      --manifest "$HOME/track_robot_ws/rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json" \
...
~~~bash
bash -lc 'source /opt/ros/foxy/setup.bash && source /home/track-robot/track_robot_ws/install/setup.bash && cd /home/track-robot/track_robot_ws && ros2 run track_robot_semantic_search semantic_search_manifest create-legacy rosbags/human_tracking_lidar_20260706_150711 rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json --dataset-id human_tracking_lidar_20260706_150711 --workspace-root /home/track-robot/track_robot_ws'
bash -lc 'source /opt/ros/foxy/setup.bash && source /home/track-robot/track_robot_ws/install/setup.bash && cd /home/track-robot/track_robot_ws && ros2 run track_robot_semantic_search semantic_search_manifest validate rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json'
~~~
...
- Create: rosbags/semantic_search/reports/README.md
- Create from evaluator output: rosbags/semantic_search/reports/phase0_baseline_2026-07-14.json
...
ros2 launch track_robot_semantic_search semantic_search_phase0.launch.py \
  ...
  manifest_path:=$HOME/track_robot_ws/rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json \
  output_path:=$HOME/track_robot_ws/rosbags/semantic_search/reports/phase0_baseline_2026-07-14.json \
...
~~~bash
REPORT_PATH=$HOME/track_robot_ws/rosbags/semantic_search/reports/phase0_baseline_2026-07-14.json
test -s "$REPORT_PATH" && python3 -m json.tool "$REPORT_PATH" >/dev/null
~~~
...
~~~bash
bash -lc 'source /opt/ros/foxy/setup.bash && source /home/track-robot/track_robot_ws/install/setup.bash && ros2 run track_robot_semantic_search semantic_search_compare_reports --manifest rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json /tmp/semantic_search_rate_05.json rosbags/semantic_search/reports/phase0_baseline_2026-07-14.json /tmp/semantic_search_rate_20.json'
~~~
