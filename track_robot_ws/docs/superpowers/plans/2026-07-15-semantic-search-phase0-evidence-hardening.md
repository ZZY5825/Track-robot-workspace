...
- Replace the tracked 2026-07-14 report with `rosbags/semantic_search/reports/phase0_baseline_2026-07-15.json`; Git history retains the old report.
- The design authority is `docs/superpowers/specs/2026-07-15-semantic-search-phase0-evidence-hardening-design.md`.
...
- Modify: `src/track_robot_semantic_search/test/test_evaluation.py`
- Modify: `rosbags/semantic_search/semantic_search_rosbag_guide.md`
- Modify: `rosbags/semantic_search/reports/README.md`
- Modify: `src/track_robot_semantic_search/README.md`
- Modify: `docs/superpowers/plans/2026-07-13-semantic-search-phase0-contracts-replay-profiling.md`
...
rg -n "--manifest|foxy_wall_time_scaled|arrival_monotonic|0.90" \
  ...
  docs/superpowers/plans/2026-07-13-semantic-search-phase0-contracts-replay-profiling.md
...
**Files:**
- Modify: `rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json`
- Delete: `rosbags/semantic_search/reports/phase0_baseline_2026-07-14.json`
- Create: `rosbags/semantic_search/reports/phase0_baseline_2026-07-15.json`
...
ros2 run track_robot_semantic_search semantic_search_manifest create-legacy \
  /home/track-robot/track_robot_ws/rosbags/human_tracking_lidar_20260706_150711 \
...
MANIFEST=$WORKTREE/rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json
OUTPUT_10=$WORKTREE/rosbags/semantic_search/reports/phase0_baseline_2026-07-15.json
...
ros2 run track_robot_semantic_search semantic_search_compare_reports \
  ...
  rosbags/semantic_search/reports/phase0_baseline_2026-07-15.json \
...
```bash
git rm rosbags/semantic_search/reports/phase0_baseline_2026-07-14.json
git add \
  rosbags/semantic_search/manifests/legacy/human_tracking_lidar_20260706_150711.json \
  rosbags/semantic_search/reports/phase0_baseline_2026-07-15.json
git diff --cached --check
