...
_EXPLICIT_ARGUMENT_NAMES = '_target_follow_controller_explicit_argument_names'
_PROFILE_OWNED_ARGUMENTS = {
    'follow_distance',
    'max_linear_x',
    'max_angular_z',
    'linear_accel_limit',
...
def _profile_parameters(context, overrides, profile_owned_arguments=()):
    parameters = []
        ...
        GroupAction(
            ...
            actions=[
                ...
                DeclareLaunchArgument(
                    'decision_topic', default_value='/follow/decision'),
                DeclareLaunchArgument(
                    'rc_state_topic', default_value='/bunker_rc_state'),
                DeclareLaunchArgument(
                    'debug_cmd_vel_topic', default_value='/follow/cmd_vel_debug'),
                DeclareLaunchArgument(
                    'planned_cmd_vel_topic', default_value='/follow/cmd_vel_planned'),
                DeclareLaunchArgument(
                    'debug_text_topic', default_value='/follow/controller_debug'),
                DeclareLaunchArgument(
                    'marker_topic', default_value='/follow/controller_markers'),
                ...
                DeclareLaunchArgument(
                    'enable_service', default_value='/follow/enable_cmd_vel'),
                DeclareLaunchArgument(
                    'disable_service', default_value='/follow/disable_cmd_vel'),
                ...
                DeclareLaunchArgument(
                    'lidar_only_no_motion_distance', default_value='1.8'),
                DeclareLaunchArgument('rc_override_deadband', default_value='10'),
                DeclareLaunchArgument(
                    'require_gesture_relock_after_rc_override', default_value='true'),
                DeclareLaunchArgument(
                    'allow_lidar_only_forward_motion', default_value='false'),
