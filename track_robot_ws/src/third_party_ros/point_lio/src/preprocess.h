...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  void process_cut_frame_pcl2(const sensor_msgs::PointCloud2::ConstSharedPtr &msg, deque<PointCloudXYZI::Ptr> &pcl_out, deque<double> &time_lidar, const int required_frame_num, int scan_count);
  ...
  void hesai_handler(const sensor_msgs::PointCloud2::ConstSharedPtr &msg);
