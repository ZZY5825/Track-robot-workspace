...
extern int lidar_debug_effect_num;
extern double lidar_debug_residual_mean;
extern double lidar_debug_residual_max;
extern double lidar_debug_nn_max_dist_mean;
extern double lidar_debug_nn_max_dist_max;
